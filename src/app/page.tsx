...
import { Home, Users, Building2, LayoutDashboard, User, ChevronRight } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="mb-10">
        ...
        <div className="h-1 w-24 bg-gradient-to-r from-primary-500 to-primary-600 rounded-full"></div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-10">
        {stats.map((stat) => (
          <Link
            key={stat.name}
            href={stat.href}
            className="group bg-white overflow-hidden shadow-sm rounded-xl border border-neutral-100 hover:shadow-lg hover:border-neutral-200 transition-all duration-200 transform hover:-translate-y-1"
          >
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5 flex-1">
                  <h3 className="text-sm font-semibold text-neutral-500 uppercase tracking-wide">{stat.name}</h3>
                  <div className="mt-2">
            ...
            {listings.length === 0 ? (
              ...
              <div className="space-y-4">
                {listings.slice(0, 5).map((listing) => (
                  <div key={listing._id} className="flex items-center space-x-4 p-3 rounded-lg hover:bg-neutral-50 transition-colors">
            ...
            {leads.length === 0 ? (
              ...
              <div className="space-y-4">
                {leads.slice(0, 5).map((lead) => (
                  <div key={lead._id} className="flex items-center space-x-4 p-3 rounded-lg hover:bg-neutral-50 transition-colors">
                    <div className="flex-shrink-0">
